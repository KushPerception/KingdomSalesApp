  ...
  return (
    <TouchableOpacity style={styles.poCard} onPress={() => onPress?.(item)} activeOpacity={0.85}>
      ...
      <View style={styles.poCardRow}>
        <Text style={styles.poLabel}>Date: <Text style={styles.poValue}>{poDate}</Text></Text>
        <Text style={[styles.poLabel, {marginLeft: 12}]}>Dept: <Text style={styles.poValue}>{item.DEPARTMENT}</Text></Text>
      </View>
      <Text style={styles.poLabel}>Supplier: <Text style={styles.poValue}>{item.SUPNAME?.trim()}</Text></Text>
      <View style={styles.poCardRow}>
        <Text style={styles.poLabel}>Amount: <Text style={styles.poValue}>{item.NETAMT} {item.CURRENCY}</Text></Text>
